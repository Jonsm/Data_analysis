...
fname = 'T1T2E_YOKO_28.583mA_Cav7.3649GHz_-15dBm_Qubit0.5041GHz_25dBm_PiPulse800ns_Count20_TimeStep20000.h5'
...
guess = [phase_t1[0]-phase_t1[-1], 200e-6, 0, phase_t1[-1]]
...
guess = [phase_t2[0]-phase_t2[-1], 100e-6, 0, phase_t2[-1]]
