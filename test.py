...
d_guess = 0.125
offset_squid_guess = 0.1
offset_ext_guess = 0.3
...
def fit_func(current, E_l, E_c, E_j_sum, d, A_j, A_c, offset_squid, offset_ext):
    ...
    for idx in range(len(current)):
        ...
        trans_energy[idx] = abs(energies[1] - energies[0])
    return trans_energy
...
spec_fit = fit_func(current_nice, E_l_fit, E_c_fit, E_j_fit, d_fit, A_j_fit, A_c_fit, offset_squid_fit, offset_ext_fit)
